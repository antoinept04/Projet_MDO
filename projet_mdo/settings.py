"""
Django settings for projet_mdo project.
...
SECRET_KEY = 'django-insecure-k+ru7(wxti&tu#nemgm%oo!led@k4yw21&d4=jmr#*t!9tya2-'
...
WSGI_APPLICATION = 'projet_mdo.wsgi.application'
