# Generated by Django 4.2 on 2024-11-29 23:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Fournisseur',
            fields=[
                ('nom_fournisseur', models.CharField(max_length=100, primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fournisseur', models.ForeignKey(db_column='fournisseur_nom', on_delete=django.db.models.deletion.CASCADE, to='gui.fournisseur')),
            ],
            options={
